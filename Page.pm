package App::Schema::Result::Page;
...
#__PACKAGE__->has_many(user_saved=>'CGC::Schema::Result::UserStarred', 'page_id');
#__PACKAGE__->has_many(comments=>'CGC::Schema::Result::Comment', 'page_id');
